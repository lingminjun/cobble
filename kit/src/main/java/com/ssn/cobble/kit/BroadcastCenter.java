...
public class BroadcastCenter {
    ...
    public boolean applicationDidLaunch(Application application) {
        if (_application != null) {
            Log.i("BroadcastCenter", "BroadcastCenter didLauch 方法 务必在Application onCreate方法中调用，调用一次后失效！！！");
            return false;
        }
        ...
        synchronized (this) {
            ...
            if (weakObserver != null) {//注册过其他方法
                ...
                if (weakObserver.add(notificationName, method)) {
                    ...
                    Log.i("BroadcastCenter", "监听者" + Integer.toString(key) + "添加注册" + notificationName + "通知");
                } else {
                    Log.i("BroadcastCenter", "监听者" + Integer.toString(key) + "重复添加注册" + notificationName + "通知！忽略");
                }
    ...
    public void removeObserver(Object observer,String notificationName) {
        ...
        synchronized (this) {
            ...
            if (TextUtils.isEmpty(notificationName)) {//remove all
                ...
                Log.i("BroadcastCenter", "监听者" + Integer.toString(key) + "移除所有注册通知");
            }
            else {
                ...
                if (weakObserver.methodCount() == 0) {
                    ...
                    Log.i("BroadcastCenter", "监听者" + Integer.toString(key) + "移除通知" + notificationName);
                }
...
//        System.gc();
    ...
    private void clearObserver(int key) {
        ...
        if (observer == null) {
            Log.i("BroadcastCenter", "监听者" + Integer.toString(key) + "已经在前一次被JVM回收");
            return;
        }
        ...
        observer.clear();
        Log.i("BroadcastCenter", "监听者" + Integer.toString(key) + "被JVM回收");
    }
